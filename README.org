#+TITLE: Samples of .NET's CIL code
#+DATE: [2025-08-06 Wed]

** About

This repository contains some simple programs written directly in .NET's [[https://en.wikipedia.org/wiki/Common_Intermediate_Language][common
